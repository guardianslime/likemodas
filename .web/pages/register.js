...
export function Fragment_931f76cf322bd16a3922c5de029799b9 () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_b9f5fd646bce4ffc40c14812143b6721 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["password"] : getRefValue(refs["ref_password"]), ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["email"] : getRefValue(refs["ref_email"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_b9f5fd646bce4ffc40c14812143b6721}>
...
export function Errorboundary_e64f29fbdf52aca2a463c882f4dccf5a () {
...
<Fragment_931f76cf322bd16a3922c5de029799b9/>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_e64f29fbdf52aca2a463c882f4dccf5a/>
  )
}
