...
export function Fragment_eb61a03e182400613061cb1fa4e85d29 () {
  ...
  <NextLink href={`${state__local_auth_state__session_state__blog_post_state.blog_post_edit_url}`} passHref={true}>
  {`Edit`}
</NextLink>
</RadixThemesLink>
</Fragment>
  ...
  <RadixThemesText as={`p`}>
  {`User info id`}
  {state__local_auth_state__session_state__blog_post_state.post?.userinfo_id}
</RadixThemesText>
  <RadixThemesText as={`p`}>
  {`User info: `}
  {JSON.stringify(state__local_auth_state__session_state__blog_post_state.post?.userinfo)}
</RadixThemesText>
  <RadixThemesText as={`p`}>
  {`User: `}
  {JSON.stringify(state__local_auth_state__session_state__blog_post_state.post?.userinfo.user)}
</RadixThemesText>
  <RadixThemesText as={`p`}>
  {state__local_auth_state__session_state__blog_post_state.post?.publish_date}
</RadixThemesText>
  <RadixThemesText as={`p`} css={{"whiteSpace": "pre-wrap"}}>
  {state__local_auth_state__session_state__blog_post_state.post?.content}
</RadixThemesText>
</RadixThemesFlex>
</Fragment>
) : (
...
export default function Component() {
  ...
  <Fragment_eb61a03e182400613061cb1fa4e85d29/>
  <NextHead>
  <title>
  {`Full Stack Python | Blog/[Blog Id]`}
</title>
