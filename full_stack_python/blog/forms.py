...
def blog_post_form() -> rx.Component:
    ...
    return rx.form(
        rx.vstack(
            ...
            rx.flex(
                rx.switch(is_checked=BlogPostState.post_publish_active, on_change=BlogPostState.set_post_publish_active, name='publish_active'),
                rx.text("Publicar"),
            ...
            rx.cond(
                ...
                rx.hstack(
                    rx.input(value=BlogPostState.publish_date_str, on_change=BlogPostState.set_publish_date_str, type='date', name='publish_date', width='100%'),
                    rx.input(value=BlogPostState.publish_time_str, on_change=BlogPostState.set_publish_time_str, type='time', name='publish_time', width='100%'),
                    width='100%'
                ),
            ),
