...
# Se unifica el nombre del slug dinámico a '[id]' para que coincida
# con la definición en `blog_public_detail.py`.
app.add_page(
    blog_public_detail.blog_public_detail_page, 
    route=f"{navigation.routes.BLOG_PUBLIC_DETAIL_ROUTE}/[id]", # ANTES: [blog_public_id]
