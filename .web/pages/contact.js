...
export function Fragment_7ae7f9eff9759e405a46e8309c25fd0b () {
  ...
  const state__local_auth_state__session_state__contact_state = useContext(StateContexts.state__local_auth_state__session_state__contact_state)
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs['ref_my_navbar_hstack_desktop'] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_72bc477878aeabd36e64ea9fba13ef77 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...{}}

        addEvents([Event("state.local_auth_state.session_state.contact_state.handle_submit", {form_data:form_data})])
  ...
  {isTrue(state__local_auth_state__session_state__contact_state.did_submit) ? state__local_auth_state__session_state__contact_state.thank_you : ``}
  <RadixThemesBox css={{"@media screen and (min-width: 0)": {"display": "none"}, "@media screen and (min-width: 30em)": {"display": "none"}, "@media screen and (min-width: 48em)": {"display": "none"}, "@media screen and (min-width: 62em)": {"display": "block"}}}>
  <RadixThemesBox css={{"width": "50vw"}}>
  <RadixFormRoot className={`Root`} css={{"width": "100%"}} onSubmit={handleSubmit_72bc477878aeabd36e64ea9fba13ef77}>
...
export default function Component() {
  ...
  <Fragment_7ae7f9eff9759e405a46e8309c25fd0b/>
  <NextHead>
  <title>
  {`Full Stack Python | Contact`}
</title>
