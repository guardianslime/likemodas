...
# --- ¡NUEVO! Funciones de carga con nombre para evitar el error de lambda ---
...
# --- ¡CORRECCIÓN FINAL! Se usan las funciones con nombre ---
# Páginas de Blog
app.add_page(
    blog_post_list_page,
    route=navigation.routes.BLOG_POSTS_ROUTE,
    on_load=blog_list_loader
)
app.add_page(blog_post_add_page, route=navigation.routes.BLOG_POST_ADD_ROUTE)
app.add_page(
    blog_post_detail_page,
    route="/blog/[blog_id]",
    on_load=blog_detail_loader
)
app.add_page(
    blog_post_edit_page,
