...
export function Fragment_aeee37a2b97601b53c48700927a660d1 () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_9d85b43d975419c91a3c1ff7d41e5f4d = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({  })};

        (((...args) => (addEvents([(Event("reflex___state____state.full_stack_python___blog___state____blog_post_state.full_stack_python___blog___state____blog_add_post_form_state.handle_submit", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_9d85b43d975419c91a3c1ff7d41e5f4d}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} direction={"column"} gap={"3"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["width"] : "100%" })} direction={"row"} gap={"3"}>

<RadixThemesTextField.Root css={({ ["width"] : "100%" })} name={"title"} placeholder={"Title"} required={false} type={"text"}/>
</RadixThemesFlex>
<RadixThemesTextArea css={({ ["height"] : "50vh", ["width"] : "100%" })} name={"content"} placeholder={"Your message"} required={true}/>
...
export function Errorboundary_7676c26540a56e090ef10726926969f2 () {
...
<Fragment_aeee37a2b97601b53c48700927a660d1/>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_7676c26540a56e090ef10726926969f2/>
  )
}
