...
def blog_post_add_form() -> rx.Component:
    """El formulario rediseñado para añadir un nuevo producto con una estructura de una sola columna."""
    return rx.form(
        rx.vstack(
            rx.heading("Añadir Nuevo Producto", size="8", margin_bottom="1em"),

            # --- SECCIÓN 1: Carga de Imágenes ---
            rx.card(
                rx.vstack(
                    rx.upload(
                        rx.vstack(
            ...
            # --- SECCIÓN 3: Características Adicionales ---
            rx.vstack(
                rx.cond(
                ...
                rx.cond(
                    ...
                    rx.grid(
                        ...
                        columns={"base": "1", "sm": "2"}, spacing="4", width="100%"
                    )
                ),
                rx.cond(
