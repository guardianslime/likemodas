...
# Esta lógica robusta lee la variable de entorno como texto y la procesa manualmente.
...
# Eliminamos duplicados para tener una lista limpia.
...
config = rx.Config(
    ...
    # Desactivamos el plugin para eliminar el warning molesto.
