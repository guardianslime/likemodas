...
export function Root_8c8e738fc9d1e8d53e7ed04badb738fd () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_4eb626c79222c2f4f6c61c73a8f96e08 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["email"] : getRefValue(refs["ref_email"]), ["password"] : getRefValue(refs["ref_password"]) })};
  ...
  return (
    jsx(
RadixFormRoot,
{className:"Root ",css:({ ["width"] : "100%" }),onSubmit:handleSubmit_4eb626c79222c2f4f6c61c73a8f96e08},
jsx(
RadixThemesFlex,
...
export function Fragment_48db64a3e67a4ce24f8d5770ef2bd245 () {
...
jsx(Fragment_b32b8e8319751bbc0cd30d6abbbc7f17,{},)
,),jsx(
RadixThemesFlex,
{css:({ ["display"] : "flex", ["alignItems"] : "center", ["justifyContent"] : "center", ["width"] : "100%" })},
...
export function Fragment_b32b8e8319751bbc0cd30d6abbbc7f17 () {
...
RadixThemesCard,
{},
jsx(Root_8c8e738fc9d1e8d53e7ed04badb738fd,{},)
,),))),)
  )
}
...
Fragment,
{},
jsx(Fragment_48db64a3e67a4ce24f8d5770ef2bd245,{},)
,jsx(
NextHead,
{},
jsx(
