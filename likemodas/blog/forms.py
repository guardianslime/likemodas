...
def blog_post_add_form() -> rx.Component:
    ...
    return rx.form(
        rx.vstack(
            ...
            # --- SECCIÓN SUPERIOR: Imagen y Detalles ---
            rx.grid(
                ...
                # --- ✨ CAMBIO CLAVE: Se define la proporción y la respuesta en pantallas pequeñas ---
                columns={"base": "1", "md": "2fr 3fr"}, # Columna izquierda 40%, derecha 60%
                spacing="6",
                width="100%",
                align_items="stretch", # Esto asegura que ambas columnas tengan la misma altura
            ),
            
            # --- SECCIÓN INFERIOR: Características Adicionales ---
            rx.vstack(
                rx.cond(
                    BlogAddFormState.category != "",
                    rx.hstack(
                        rx.heading("Características Adicionales", size="6"),
                        rx.spacer(),
                        rx.button(
                            "Limpiar",
