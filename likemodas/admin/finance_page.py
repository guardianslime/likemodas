# likemodas/admin/finance_page.py (VERSIÓN MEJORADA Y CORREGIDA)
    ...
    return rx.card(
        rx.vstack(
            ...
            rx.cond(
                ...
                # --- CORRECCIÓN DE GRÁFICA ---
                # Usamos ResponsiveContainer con una altura fija para asegurar que se renderice.
                rx.box(
                ...
                rx.hstack(
                    ...
                    rx.vstack(
                        ...
                        rx.hstack(
                            ...
                            rx.vstack(
                                rx.text("Ganancia", size="2"),
                                rx.heading(AppState.selected_variant_detail.total_profit_cop, size="4"),
                                align_items="start", spacing="0"
                            ),
                            spacing="5",
                        ),
                ...
                rx.vstack(
                    ...
                    rx.tabs.root(
                        ...
                        rx.tabs.content(
                            rx.vstack(
                                rx.grid(
                                    stat_card("Unidades Totales Vendidas", AppState.selected_product_detail.total_units_sold.to_string(), "package-check"),
                    ...
                    rx.flex(
                        rx.dialog.close(rx.button("Cerrar", on_click=AppState.close_product_detail_modal, variant="soft", color_scheme="gray")),
                        justify="end",
                        width="100%",
                        margin_top="1em"
                    ),
...
def finance_page_content() -> rx.Component:
    """Página del dashboard financiero con la UI mejorada."""
    return rx.fragment(
        rx.center(
            rx.vstack(
