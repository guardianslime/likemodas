        ...
        rx.vstack(
            ...
            rx.cond(
                ...
                rx.text(
                    ...
                    # Usamos la propiedad calculada del estado
                    state.BlogPostState.post_publish_date_formatted
                ),
                rx.text("Este post aún no ha sido publicado.")
            ),
            rx.cond(
                state.BlogPostState.post.image_url,
                rx.image(
                    src=state.BlogPostState.post.image_url,
