...
export function Root_7a981f34d0ee0d45c81dea74abc27a95 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_da103b5f572ed17508c8a5d2e71f6ae6 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["email"] : getRefValue(refs["ref_email"]), ["username"] : getRefValue(refs["ref_username"]), ["password"] : getRefValue(refs["ref_password"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]) })};
  ...
  return (
    jsx(
RadixFormRoot,
{className:"Root ",css:({ ["width"] : "100%" }),onSubmit:handleSubmit_da103b5f572ed17508c8a5d2e71f6ae6},
jsx(
RadixThemesFlex,
...
export function Fragment_12d6c579869c104dd959f55efe9f654f () {
...
jsx(Fragment_f4df1ef31bd6d553be9e1eab998afd1f,{},)
,),jsx(
RadixThemesFlex,
{css:({ ["display"] : "flex", ["alignItems"] : "center", ["justifyContent"] : "center", ["width"] : "100%" })},
...
export function Fragment_f4df1ef31bd6d553be9e1eab998afd1f () {
...
RadixThemesCard,
{},
jsx(Root_7a981f34d0ee0d45c81dea74abc27a95,{},)
,),))),)
  )
}
...
Fragment,
{},
jsx(Fragment_12d6c579869c104dd959f55efe9f654f,{},)
,jsx(
NextHead,
{},
jsx(
