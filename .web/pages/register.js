...
export function Errorboundary_600faf8fc7beb1dda091b2a089ce3cf0 () {
...
<Fragment_77f81991dc32383d4a3b84fb1226a02f/>
<NextHead>
...
export function Fragment_77f81991dc32383d4a3b84fb1226a02f () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_93af61227f11e1659b10e8ab132e61e2 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["password"] : getRefValue(refs["ref_password"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["username"] : getRefValue(refs["ref_username"]), ["email"] : getRefValue(refs["ref_email"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_93af61227f11e1659b10e8ab132e61e2}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_600faf8fc7beb1dda091b2a089ce3cf0/>
  )
}
