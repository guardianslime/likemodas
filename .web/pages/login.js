...
export function Fragment_8167737af8583d35f8d0868200cc3908 () {
  ...
  const state__local_auth_state__login_state = useContext(StateContexts.state__local_auth_state__login_state)
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs['ref_my_navbar_hstack_desktop'] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_e5f1e069224d17b667cf2101fbbcd68d = useCallback((ev) => {
        ...
        addEvents([Event("state.local_auth_state.login_state.on_submit", {form_data:form_data})])
  ...
  <Fragment>
  <RadixThemesCard>
  <RadixFormRoot className={`Root`} css={{"width": "100%"}} onSubmit={handleSubmit_e5f1e069224d17b667cf2101fbbcd68d}>
  <RadixThemesFlex align={`start`} className={`rx-Stack`} css={{"minWidth": "50vw"}} direction={`column`} gap={`3`}>
  <RadixThemesHeading size={`7`}>
  {`Login into your Account`}
</RadixThemesHeading>
  <Fragment>
  {isTrue(((state__local_auth_state__login_state.error_message) !== (""))) ? (
  <Fragment>
  ...
  {state__local_auth_state__login_state.error_message}
</RadixThemesCallout.Text>
  ...
  <RadixThemesLink css={{"&:hover": {"color": "var(--accent-8)"}}} onClick={(_e) => addEvents([Event("state.local_auth_state.registration_state.redir", {})], (_e), {})}>
  {`Register`}
</RadixThemesLink>
</RadixThemesFlex>
</RadixThemesFlex>
...
export default function Component() {
  ...
  <Fragment_8167737af8583d35f8d0868200cc3908/>
  <NextHead>
  <title>
  {`login`}
</title>
