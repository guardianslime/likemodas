...
def blog_post_add_form() -> rx.Component:
    """
    Formulario para añadir productos con un diseño responsivo único que se adapta
    a móvil y escritorio.
    """
    return rx.form(
        rx.vstack(
            ...
            rx.grid(
                # --- Columna Izquierda (Desktop) / Fila 1 (Móvil) ---
                rx.vstack(
                    rx.card(
                        rx.vstack(
                            rx.upload(
                ...
                # --- Columna Derecha (Desktop) / Fila 2 (Móvil) ---
                rx.vstack(
                ...
                # --- Fila Inferior (Desktop) / Fila 3 (Móvil) ---
                rx.vstack(
                    ...
                    grid_column={"base": "span 1", "md": "span 2"},
                    margin_top="1em",
                    align_items="start",
                    width="100%"
                ),
                
                # --- Propiedades responsivas del Grid principal ---
