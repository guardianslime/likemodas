...
Revision ID: 6c48c2ad7301
Revises: 37a22d018f3f
Create Date: 2025-07-17 23:10:10.634462
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('userinfo', schema=None) as batch_op:
        batch_op.add_column(sa.Column('role', sa.Enum('CUSTOMER', 'ADMIN', name='userrole'), server_default='customer', nullable=False))
