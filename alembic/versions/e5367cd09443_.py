...
Revision ID: e5367cd09443
Revises: 
Create Date: 2025-08-28 23:31:36.992860
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING_CONFIRMATION', 'CONFIRMED', 'SHIPPED', 'DELIVERED', name='purchasestatus'), nullable=False),
