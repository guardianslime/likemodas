...
from .pages import search_results, about, pricing, dashboard_component, category_page
...
app.add_page(dashboard_component.dashboard_component, route="/dashboard", on_load=cart_state.CartState.on_load)
