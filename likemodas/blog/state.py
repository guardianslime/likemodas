    ...
    def on_load(self):
        ...
        with rx.session() as session:
            ...
            if post_sin_filtros:
                ...
                print(f"   - publish_active: {post_sin_filtros.publish_active} (Debería ser True)")
                print(f"   - publish_date: {post_sin_filtros.publish_date} (Debería ser una fecha pasada)")
            else:
