...
export function Root_7620da7cd27b2c1619395e329ccaff15 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_fe6578d65ed371f294ae6e6e7fc17e69 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["password"] : getRefValue(refs["ref_password"]), ["email"] : getRefValue(refs["ref_email"]), ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]) })};
  ...
  return (
    jsx(
RadixFormRoot,
{className:"Root ",css:({ ["width"] : "100%" }),onSubmit:handleSubmit_fe6578d65ed371f294ae6e6e7fc17e69},
jsx(
RadixThemesFlex,
...
export function Fragment_51e795c7c2b6ddde25efa15fb4137fdb () {
...
RadixThemesCard,
{},
jsx(Root_7620da7cd27b2c1619395e329ccaff15,{},)
,),))),)
  )
}

export function Fragment_c55a2fc735ec07781fd95e7c3bf79ee9 () {
...
jsx(Fragment_51e795c7c2b6ddde25efa15fb4137fdb,{},)
,),jsx(
RadixThemesFlex,
{css:({ ["display"] : "flex", ["alignItems"] : "center", ["justifyContent"] : "center", ["width"] : "100%" })},
...
Fragment,
{},
jsx(Fragment_c55a2fc735ec07781fd95e7c3bf79ee9,{},)
,jsx(
NextHead,
{},
jsx(
