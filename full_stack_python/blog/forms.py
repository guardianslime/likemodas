...
def blog_post_add_form() -> rx.Component:
    ...
    return rx.form(
        rx.vstack(
            rx.input(name="title", placeholder="Título", required=True, width="100%"),
            rx.text_area(name="content", placeholder="Contenido de la publicación", required=True, height='30vh', width='100%'),
...
def blog_post_edit_form() -> rx.Component:
    ...
    return rx.form(
        ...
        rx.vstack(
            rx.input(default_value=rx.cond(post, post.title, ""), name="title", placeholder="Título", required=True, width='100%'),
            rx.text_area(value=BlogEditFormState.post_content, on_change=BlogEditFormState.set_post_content, name='content', placeholder='Contenido de la publicación', required=True, height='30vh', width='100%'),
            ...
            rx.cond(
                ...
                rx.hstack(
                    rx.input(value=BlogEditFormState.publish_date_str, on_change=BlogEditFormState.set_publish_date_str, type='date', name='publish_date', width='100%'),
                    rx.input(value=BlogEditFormState.publish_time_str, on_change=BlogEditFormState.set_publish_time_str, type='time', name='publish_time', width='100%'),
                    width='100%'
                ),
            ),
