...
Revision ID: b9b5baf1a5ab
Revises: 
Create Date: 2025-08-25 02:30:01.679402
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'SHIPPED', 'DELIVERED', name='purchasestatus'), nullable=False),
