...
export function Errorboundary_109237c9ec85e514b07dbd6d1436906b () {
...
<Fragment_56ec8f897184172d81910231af151d42/>
</Fragment>
<NextHead>
...
export function Fragment_56ec8f897184172d81910231af151d42 () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_fc3d5109b6b7918410e4ef255d25a9ed = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({  })};

        (((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.full_stack_python___auth___state____session_state.full_stack_python___blog___state____blog_post_state.full_stack_python___blog___state____blog_add_post_form_state.handle_submit", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_fc3d5109b6b7918410e4ef255d25a9ed}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_109237c9ec85e514b07dbd6d1436906b/>
  )
}
