...
def blog_post_add_content() -> rx.Component:
    """
    Página de creación de publicación con previsualización y sección de personalización rediseñada.
    """
    return rx.hstack(
        rx.grid(
            rx.vstack(
            ...
            rx.vstack(
                ...
                # --- ✨ INICIO: SECCIÓN "Personalizar Tarjeta" COMPLETAMENTE NUEVA ✨ ---
                rx.vstack(
                    ...
                    # Switch para usar el estilo predeterminado
                    rx.hstack(
                    ...
                    # Controles de personalización (se ocultan si el estilo predeterminado está activo)
                    rx.cond(
                        ...
                        rx.vstack(
                            ...
                            # Color Pickers para los colores 'vivos'
                            rx.popover.root(
                                rx.popover.trigger(
                                    rx.button(
                                        rx.hstack(
                ...
                # --- ✨ FIN: SECCIÓN "Personalizar Tarjeta" COMPLETAMENTE NUEVA ✨ ---
