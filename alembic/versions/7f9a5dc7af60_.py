...
Revision ID: 7f9a5dc7af60
Revises: 
Create Date: 2025-12-12 23:05:14.361760
...
def upgrade() -> None:
    ...
    sa.Column('moda_completa_cities', sa.JSON(), nullable=True),
    sa.Column('combined_shipping_cities', sa.JSON(), nullable=True),
    ...
    sa.Column('use_default_style', sa.Boolean(), nullable=False),
    sa.Column('card_theme_invert', sa.Boolean(), nullable=False),
    sa.Column('light_card_bg_color', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('light_title_color', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('light_price_color', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('dark_card_bg_color', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('dark_title_color', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('image_styles', sa.JSON(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('requester_username', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.Column('anonymous_customer_email', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['action_by_id'], ['userinfo.id'], ),
    sa.ForeignKeyConstraint(['userinfo_id'], ['userinfo.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
