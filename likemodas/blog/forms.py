    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.select(
                ...
                size="3", # Tamaño añadido
            ),
            rx.button("Añadir", on_click=add_handler, type="button", color_scheme="violet", variant="soft", size="3"), # Tamaño añadido
            width="100%"
        ),
...
def variant_stock_manager() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.text("Genera combinaciones y asigna un stock inicial a cada una.", size="3", color_scheme="gray"), # Tamaño aumentado
        rx.button("Generar / Actualizar Variantes", on_click=AppState.generate_variants, margin_y="1em", type="button", color_scheme="violet", size="3"), # Tamaño añadido
        rx.cond(
                    ...
                    lambda variant, index: rx.box(
                        rx.hstack(
                            ...
                            rx.select(
                                ...
                                max_width="150px",
                                size="2", # Un poco más pequeño para esta sección
                            ),
