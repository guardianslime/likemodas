...
export function Fragment_30773f24161ef092fbf2e56cbd735c51 () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs['ref_my_navbar_hstack_desktop'] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_d9c843cf67a448d43f97216ac8ea215c = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...{}}

        addEvents([Event("state.local_auth_state.session_state.blog_post_state.blog_add_post_form_state.handle_submit", {form_data:form_data})])
  ...
  <RadixFormRoot className={`Root`} css={{"width": "100%"}} onSubmit={handleSubmit_d9c843cf67a448d43f97216ac8ea215c}>
...
export default function Component() {
  ...
  <Fragment>
  <Fragment_30773f24161ef092fbf2e56cbd735c51/>
</Fragment>
  <NextHead>
  <title>
  {`Full Stack Python | Blog/Add`}
</title>
