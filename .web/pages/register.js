...
export function Fragment_f25bd91f9df638880ae41057de565091 () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_f9c0e5552aaf7397d3d2ba21d292179e = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["username"] : getRefValue(refs["ref_username"]), ["password"] : getRefValue(refs["ref_password"]), ["email"] : getRefValue(refs["ref_email"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_f9c0e5552aaf7397d3d2ba21d292179e}>
...
export function Errorboundary_5565b81cfe535ac890ae3aff8cc40077 () {
...
<Fragment_f25bd91f9df638880ae41057de565091/>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_5565b81cfe535ac890ae3aff8cc40077/>
  )
}
